...
#define IHELICOPTER_START_BIT_PULSE_LEN_MIN        ((uint8_t)(F_INTERRUPTS * IHELICOPTER_START_BIT_PULSE_TIME * MIN_TOLERANCE_20 + 0.5) - 1)
#define IHELICOPTER_START_BIT_PULSE_LEN_MAX        ((uint8_t)(F_INTERRUPTS * IHELICOPTER_START_BIT_PULSE_TIME * MAX_TOLERANCE_20 + 0.5) + 1)
#define IHELICOPTER_START_BIT_PAUSE_LEN_MIN        ((uint8_t)(F_INTERRUPTS * IHELICOPTER_START_BIT_PAUSE_TIME * MIN_TOLERANCE_20 + 0.5) - 1)
#define IHELICOPTER_START_BIT_PAUSE_LEN_MAX        ((uint8_t)(F_INTERRUPTS * IHELICOPTER_START_BIT_PAUSE_TIME * MAX_TOLERANCE_20 + 0.5) + 1)
#define IHELICOPTER_1_PULSE_LEN_MIN                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_1_PULSE_TIME * MIN_TOLERANCE_20 + 0.5) - 1)
#define IHELICOPTER_1_PULSE_LEN_MAX                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_1_PULSE_TIME * MAX_TOLERANCE_30 + 0.5) + 1)
#define IHELICOPTER_1_PAUSE_LEN_MIN                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_1_PAUSE_TIME * MIN_TOLERANCE_30 + 0.5) - 1)
#define IHELICOPTER_1_PAUSE_LEN_MAX                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_1_PAUSE_TIME * MAX_TOLERANCE_30 + 0.5) + 1)
#define IHELICOPTER_0_PULSE_LEN_MIN                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_0_PULSE_TIME * MIN_TOLERANCE_40 + 0.5) - 1)
#define IHELICOPTER_0_PULSE_LEN_MAX                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_0_PULSE_TIME * MAX_TOLERANCE_20 + 0.5) + 1)
#define IHELICOPTER_0_PAUSE_LEN_MIN                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_0_PAUSE_TIME * MIN_TOLERANCE_70 + 0.5) - 1)
#define IHELICOPTER_0_PAUSE_LEN_MAX                ((uint8_t)(F_INTERRUPTS * IHELICOPTER_0_PAUSE_TIME * MAX_TOLERANCE_40 + 0.5) + 1)

#define IHELICOPTER_PAUSE_LEN_MIN                     ((uint8_t)(F_INTERRUPTS * IHELICOPTER_PAUSE_TIME * MIN_TOLERANCE_70 + 0.5) - 1)
#define IHELICOPTER_PAUSE_LEN_MAX                     ((uint8_t)(F_INTERRUPTS * IHELICOPTER_PAUSE_TIME * MAX_TOLERANCE_70 + 0.5) + 1)
...
static const PROGMEM IRMP_PARAMETER ihelicopter_param =
{
    IRMP_IHELICOPTER_PROTOCOL,                                             // protocol:        ir protocol
...
#if IRMP_SUPPORT_IHELICOPTER_PROTOCOL == 1
                    if (irmp_pulse_time >= IHELICOPTER_START_BIT_PULSE_LEN_MIN && irmp_pulse_time <= IHELICOPTER_START_BIT_PULSE_LEN_MAX &&
                        irmp_pause_time >= IHELICOPTER_START_BIT_PAUSE_LEN_MIN && irmp_pause_time <= IHELICOPTER_START_BIT_PAUSE_LEN_MAX)
                    {                                                           // it's IHELICOPTER
                    	start_bit_counter--;
