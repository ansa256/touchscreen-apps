...
DEVICE_PROP Device_Property_Joystick =
  {
    Joystick_init,
    Joystick_Reset,
    Joystick_Status_In,
...
USER_STANDARD_REQUESTS User_Standard_Requests_Joystick =
  {
...
ONE_DESCRIPTOR Device_Descriptor_Joystick =
  {
    (uint8_t*)Joystick_DeviceDescriptor,
    JOYSTICK_SIZ_DEVICE_DESC
  };

ONE_DESCRIPTOR Config_Descriptor_Joystick =
  {
...
ONE_DESCRIPTOR String_Descriptor_Joystick[4] =
  {
