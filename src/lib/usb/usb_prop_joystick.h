...
#ifndef __USB_PROP_JOYSTICK_H
#define __USB_PROP_JOYSTICK_H
...
/* Exported variables --------------------------------------------------------*/
extern DEVICE_PROP Device_Property_Joystick;
extern USER_STANDARD_REQUESTS User_Standard_Requests_Joystick;
