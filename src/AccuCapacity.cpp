...
const char * const chartStringsExtern[] = { StringMax, StringMin, StringBoth };
...
static TouchButton * TouchButtonSetExternalAttenuatorFactor;
...
// free buttons
    ...
    TouchButtonSetExternalAttenuatorFactor->setFree();
 ...
 */
void adjustXAxisToSamplePeriod(unsigned int aProbeIndex, int aSamplePeriodSeconds) {
    const char*tXLabelText = String_min;
...
void drawAccuCapacitySettingsPage(void) {
    ...
    TouchButtonSetExternalAttenuatorFactor->setCaption(StringExternalAttenuatorFactor);
    TouchButtonSetExternalAttenuatorFactor->drawButton();
